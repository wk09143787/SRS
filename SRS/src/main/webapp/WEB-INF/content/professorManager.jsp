...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/assets/plugins/select2/select2_metro.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/plugins/data-tables/DT_bootstrap.css" />
<link
	href="${pageContext.request.contextPath}/assets/plugins/bootstrap-modal/css/bootstrap-modal-bs3patch.css"
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/assets/plugins/bootstrap-modal/css/bootstrap-modal.css"
	rel="stylesheet" type="text/css" />
<!-- END PAGE LEVEL STYLES -->
<!-- BEGIN THEME STYLES -->
<link
	href="${pageContext.request.contextPath}/assets/css/style-metronic.css"
	rel="stylesheet" type="text/css" />
...
<body class="page-header-fixed">
			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown user"><a href="#" class="dropdown-toggle"
					...
					data-close-others="true"> <img alt=""
						src="${pageContext.request.contextPath}/assets/img/avatar1_small.jpg" />
						<span class="username"> ${ sessionScope.student.name } </span> <i
						class="fa fa-angle-down"></i>
				</a>
					<ul class="dropdown-menu">
						<li><a href="#"><i class="fa fa-user"></i> 个人信息</a></li>
						<li><a href="#"><i class="fa fa-envelope"></i> 我的消息 <span
								class="badge badge-danger"> 3 </span> </a></li>
						<li><a href="#"><i class="fa fa-tasks"></i> 我的任务 <span
								class="badge badge-success"> 7 </span> </a></li>
						<li class="divider"></li>
						<li><a href="login"><i class="fa fa-key"></i> 安全退出</a></li>
					</ul></li>
		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu">
					...
					<li class="start"><a href="/index"> <i class="fa fa-home"></i>
							<span class="title"> 学生选课 </span> <span class="selected">
						</span>
					</a></li>
					<li class=""><a href="/transcript"> <i
							class="fa fa-bar-chart-o"></i> <span class="title"> 成绩查询 </span>
					</a></li>
					<li class=""><a href="/planOfStudy"> <i
							class="fa fa-table"></i> <span class="title"> 教学计划 </span>
					</a></li>
					<li class="active"><a href="/professorManager"> <i
							class="fa fa-user"></i> <span class="title"> 教师管理 </span>
					</a></li>
					<li class="last "><a href="/courseManager"> <i
							class="fa fa-file-text"></i> <span class="title"> 课程管理 </span>
					</a></li>
				</ul>
				<!-- END SIDEBAR MENU -->
			</div>
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">管理学院电子商务专业选课系统</h3>
						<ul class="page-breadcrumb breadcrumb">
							<li><i class="fa fa-home"></i> <a href="/index">主页</a> <i
								class="fa fa-angle-right"></i></li>
							<li><a href="/professorManager">教师管理</a></li>
							<li class="pull-right">
				...
				<div class="clearfix"></div>
				<div id="btn">
					<a id="btn-add" type="button" data-toggle="modal"
						href="#responsive" class="btn btn-primary">添加</a>
					<button id="btn-remove" type="button" class="btn btn-primary"
						onclick="deleteProfessor()">删除</button>
					<button id="btn-edit" type="button" class="btn btn-primary"
						onclick="editProfessor()">修改</button>
				</div>
				<!-- responsive -->
				<div id="responsive" class="modal fade" tabindex="-1"
							...
							<form id="professorForm"
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input id="ssn" name="ssn" type="text" placeholder="请输入教师编号"
												class="form-control" />
										</div>
									</div>
									<div class="form-group">
					...
					<div class="modal-footer">
						<button id="cancelTeacher" type="button" data-dismiss="modal"
	...
	<!-- BEGIN FOOTER -->
	<div class="footer">
		<div class="footer-inner">2017 &copy; 管理学院电子商务专业选课系统.</div>
...
<![endif]-->
	<script
		src="${pageContext.request.contextPath}/assets/plugins/jquery-1.10.2.min.js"
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/assets/plugins/bootstrap-hover-dropdown/twitter-bootstrap-hover-dropdown.min.js"
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/assets/plugins/jquery-slimscroll/jquery.slimscroll.min.js"
		type="text/javascript"></script>
	<script
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/assets/plugins/uniform/jquery.uniform.min.js"
		type="text/javascript"></script>
	<!-- END CORE PLUGINS -->
	...
	<script
		src="${pageContext.request.contextPath}/assets/plugins/bootstrap-modal/js/bootstrap-modalmanager.js"
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/assets/plugins/bootstrap-modal/js/bootstrap-modal.js"
		type="text/javascript"></script>
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL SCRIPTS -->
	<script src="${pageContext.request.contextPath}/assets/scripts/app.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/scripts/ui-extended-modals.js"></script>
