		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu">
					...
					<li class=""><a href="/professorManager"> <i
							class="fa fa-user"></i> <span class="title"> 教师管理 </span>
					</a></li>
					<li class="last active"><a href="/courseManager"> <i
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="/courseManager">课程管理</a></li>
							<li class="pull-right">
				...
				<div id="responsive" class="modal fade" tabindex="-1"
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="number" name="number"
												placeholder="请输入课程编号" class="form-control" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input id="name" name="name" type="text"
												placeholder="请输入课程名称" class="form-control" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input id="credits" name="credits" type="text"
												placeholder="请输入学分" class="form-control" />
										</div>
									</div>
								</div>
							</form>
					...
					<div class="modal-footer">
						<button id="cancelCourse" type="button" data-dismiss="modal"
