...
<link
	href="${pageContext.request.contextPath}/assets/css/pages/login-soft.css"
	rel="stylesheet" type="text/css" />
...
<body class="login">
	...
	<!-- BEGIN LOGO -->
	<div class="logo">
		<img src="${pageContext.request.contextPath}/assets/img/logo-big.png"
			alt="" />
	</div>
	<!-- END LOGO -->
	...
	<div class="content">
		...
		<form class="login-form" action="loginForm" method="post">
			...
			<div class="form-group">
				...
				<div class="input-icon">
					<i class="fa fa-user"></i> <input
						...
						autocomplete="off" placeholder="账号" name="ssn" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="forget-password">
				<h4>忘记密码 ?</h4>
				<p>
					不用担心, 点击 <a href="javascript:;" id="forget-password">这里</a> 找回密码.
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->
	...
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">2017 &copy; 管理学院电子商务专业选课系统.</div>
	<!-- END COPYRIGHT -->
	...
	<script
		src="${pageContext.request.contextPath}/assets/plugins/jquery-validation/dist/jquery.validate.min.js"
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/assets/plugins/backstretch/jquery.backstretch.min.js"
		type="text/javascript"></script>
	...
	<script src="${pageContext.request.contextPath}/assets/scripts/app.js"
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/assets/scripts/login-soft.js"
		type="text/javascript"></script>
	<!-- END PAGE LEVEL SCRIPTS -->
