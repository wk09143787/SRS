package com.github.wk09143787.srs.mapper;
...
public interface StudentDao {
	...
	@Results({
		...
		@Result(column="ssn" , property="attends",
				many=@Many(select="com.github.wk09143787.srs.mapper.SectionDao.selectByStudentSn",
						fetchType=FetchType.LAZY)),
		@Result(column="ssn" , property="planOfStudy",
		many=@Many(select="com.github.wk09143787.srs.mapper.CourseDao.selectByStudentSn",
				fetchType=FetchType.LAZY)),
